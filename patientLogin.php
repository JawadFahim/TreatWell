...
<head>
    ...
    <title>Patient Login | Treatwell</title>
...
<div class="wrapper">
    <form class="mt-6" action="patientLogin.php" method="POST">
        <h1>Patient Login</h1>
        <div class="input-box">
        ...
        <div class="remember-forgot">
            ...
            <a href="passwordReset.php" style="display: block;text-align: center;">Forgot Password</a>
        </div>
        <button type="submit" class="submit" name="signin">Login</button>
        <div class="register-link">
            <p>Dont have an account? <a href="patientRegister.php">Register</a></p>
        </div>
        <div class="doctor">
            <a href="doctorLogin.php">Are you a Doctor? Click Here</a>
        </div>
    </form>
</div>
</body>
