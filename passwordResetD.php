...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    switch ($_SESSION['step']) {
        case 1: // Step 1: Enter Email
            ...
            $sql = "SELECT * FROM doctor_login WHERE doctoremail = '$email'";
        ...
        case 3: // Step 3: Reset Password
            ...
            if ($password == $confirm_password) {
                ...
                $sql = "UPDATE doctor_login SET doctorPassword = '$password' WHERE doctoremail = '$email'";
...
<body style="background-size: cover; background: url(image/doctor.jpg) center;">
<div class="wrapper">
    <?php
